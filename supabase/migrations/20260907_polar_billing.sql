-- ============================================================================
-- RankMap Pro — Polar billing & plan capabilities
-- Run this in Supabase SQL Editor (Dashboard → SQL → New query)
-- ============================================================================

-- Remove enterprise tier (migrate existing users to pro)
...
-- Delete enterprise row BEFORE adding the stricter check constraint
...
-- Polar product → plan mapping (for reference; webhook uses env vars too)
...
-- No public policies — only service role reads this table

-- Extend get_current_usage with capabilities
